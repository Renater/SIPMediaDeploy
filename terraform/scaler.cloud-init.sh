...
COTURN_OPENSTACL_FLAVOR=${coturn_openstack_flavor}
...
sed -i -E "s/^OPENSTACK_FLAVOR=.*$/OPENSTACK_FLAVOR=$GATEWAY_HOST_OPENSTACK_FLAVOR/" .env
sed -i -E "s/^OPENSTACK_IMAGE=.*$/OPENSTACK_IMAGE=$GATEWAY_HOST_OPENSTACK_IMAGE/" .env
sed -i -E "s/^OPENSTACK_IP_VERSION=.*$/OPENSTACK_IP_VERSION=$OPENSTACK_IP_VERSION/" .env
sed -i -E "s/^OPENSTACK_NETWORK=.*$/OPENSTACK_NETWORK=$OPENSTACK_EXTERNAL_NETWORK/" .env
sed -i -E "s/^OPENSTACK_METADATA_KEY=.*$/OPENSTACK_METADATA_KEY=$OPENSTACK_METADATA_KEY/" .env
sed -i -E "s/^OPENSTACK_METADATA_VALUE=.*$/OPENSTACK_METADATA_VALUE=gateway/" .env
...
sed -i -E "s/^OS_INTERFACE=.*$/OS_INTERFACE=$OS_INTERFACE/" .env
sed -i -E "s/^OS_IDENTITY_API_VERSION=.*$/OS_IDENTITY_API_VERSION=$OS_IDENTITY_API_VERSION/" .env
sed -i -E "s/^OPENSTACK_FLAVOR=.*$/OPENSTACK_FLAVOR=$KAMAILIO_OPENSTACK_FLAVOR/" .env
sed -i -E "s/^OPENSTACK_IMAGE=.*$/OPENSTACK_IMAGE=$KAMAILIO_OPENSTACK_IMAGE/" .env
sed -i -E "s/^OPENSTACK_IP_VERSION=.*$/OPENSTACK_IP_VERSION=$OPENSTACK_IP_VERSION/" .env
sed -i -E "s/^OPENSTACK_NETWORK=.*$/OPENSTACK_NETWORK=$OPENSTACK_INTERNAL_NETWORK/" .env
sed -i -E "s/^OPENSTACK_METADATA_KEY=.*$/OPENSTACK_METADATA_KEY=$OPENSTACK_METADATA_KEY/" .env
sed -i -E "s/^OPENSTACK_METADATA_VALUE=.*$/OPENSTACK_METADATA_VALUE=kamailio/" .env
sed -i -E "s/^OPENSTACK_KEYPAIR=.*$/OPENSTACK_KEYPAIR=$OPENSTACK_KEYPAIR/" .env
...
sed -i -E "s/^OS_INTERFACE=.*$/OS_INTERFACE=$OS_INTERFACE/" .env
sed -i -E "s/^OS_IDENTITY_API_VERSION=.*$/OS_IDENTITY_API_VERSION=$OS_IDENTITY_API_VERSION/" .env
sed -i -E "s/^OPENSTACK_FLAVOR=.*$/OPENSTACK_FLAVOR=$COTURN_OPENSTACK_FLAVOR/" .env
sed -i -E "s/^OPENSTACK_IMAGE=.*$/OPENSTACK_IMAGE=$COTURN_OPENSTACK_IMAGE/" .env
sed -i -E "s/^OPENSTACK_IP_VERSION=.*$/OPENSTACK_IP_VERSION=$OPENSTACK_IP_VERSION/" .env
sed -i -E "s/^OPENSTACK_NETWORK=.*$/OPENSTACK_NETWORK=$OPENSTACK_INTERNAL_NETWORK/" .env
sed -i -E "s/^OPENSTACK_METADATA_KEY=.*$/OPENSTACK_METADATA_KEY=$OPENSTACK_METADATA_KEY/" .env
sed -i -E "s/^OPENSTACK_METADATA_VALUE=.*$/OPENSTACK_METADATA_VALUE=coturn/" .env
sed -i -E "s/^OPENSTACK_KEYPAIR=.*$/OPENSTACK_KEYPAIR=$OPENSTACK_KEYPAIR/" .env
sed -i -E "s/^REPLICA_CAPACITY=[0-9]*$/REPLICA_CAPACITY=1/" .env
